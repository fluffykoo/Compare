...
public class CompareJsonFiles {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ReportGenerator gen = new ReportGenerator(outFolder, ts, reportFileNameJSON);
